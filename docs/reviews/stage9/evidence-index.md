...
|---|---|---|---|---|---|---|
| EV-01 | source/unit/race/lint/vulnerability/contracts/images | `make verify` | passed: unit/PostgreSQL/race/vet/lint/contracts/secrets/npm and 19 image zero HIGH/CRITICAL gates; direct Go vulnerability feed timed out once and the pinned local official DB fallback found zero called vulnerabilities | Platform / Security | 2026-08-02 | passed |
...
| EV-11 | 19 image SBOM/scan/checksum manifest | `make release-bundle` | passed: 19 commit-addressed images, 19 SPDX files, 19 Trivy reports and 39 checksummed artifacts; manifest SHA-256 `f008479a865caf5558cdd7390f0c09e0ec30e3a3cb21ab602e888df6e0a00571` | Platform / Security | final candidate only | passed |
| EV-12 | review/license/go-no-go consistency | `make production-readiness` | passed as a control: policy remains publication NO-GO with 18 image blockers and all open hard gates are reported | Architecture / Security | 2026-08-26 | passed |
